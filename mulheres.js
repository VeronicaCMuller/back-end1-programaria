...
conectaBancoDeDados() // estou chamando a função que conectaBancoDeDados
...
async function corrigeMulher(request, response){
  try{
    ...
    if (request.body.image){
        mulherEncontrada.image = request.body.image
    }
...
app.use(router.get("/mulheres", mostrarMulheres)) // segunda configuração da rota, rota GET / mulheres
...
app.use(router.delete("/mulheres/:id" , deletaMulher)) // configurei aqui a nossa rota DELETE/mulheres/:id
